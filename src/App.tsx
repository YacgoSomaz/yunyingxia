...
export default function App() {
  ...
  return <main className="shell">
    <aside className="sidebar"><div className="brand"><span className="brand-mark">万</span><div><strong>万山自媒体</strong><small>本地创作工作台</small></div></div>
      ...
      <div className="offline">本地优先 · 无登录</div></aside>
    <section className="content"><header><div><p className="eyebrow">万山自媒体</p><h1>{view === 'workspace' ? '创作工作台' : view === 'prompts' ? '提示词库' : view === 'settings' ? '模型设置' : '本地历史'}</h1></div><p className="status">{status}</p></header>
